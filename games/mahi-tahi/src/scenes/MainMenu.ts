...
export class MainMenu extends Scene {
  ...
  preload() {
    ...
    this.load.image("background", "assets/spring_background.png");
  ...
  create() {
    ...
    const scale = Math.max(scaleX, scaleY); // cover screen without distortion
