...
export class Level3 extends FixItScene<BlockGameScoringData> {
  constructor() {
    super("Level3", "Level3", "Level4Drop", "Prevent what will happen!", "Level3Drop");
  }
  ...
  preload() {
    ...
    create() {
      ...
      this.fallBlockOne = this.matter.add.image(1050, 350, "gift", undefined, {
        isStatic: false,
        friction: 0.5,
        restitution: 0.2,
        shape: shapes.gift
      ...
      //Movable Blocks
      this.movableBlockOne = this.matter.add.image(1800, 630, "scaffolding", undefined, {
        isStatic: false,
      ...
      this.movableBlockTwo = this.matter.add.image(1800, 780, "scaffolding", undefined, {
        isStatic: false,
        shape: shapes.scaffolding
      }).setScale(0.15);
      ...
      this.movableBlockThree = this.matter.add.image(1800, 915, "scaffolding", undefined, {
        isStatic: false,
        shape: shapes.scaffolding
      }).setScale(0.15);
    ...
    if (!this.didStructureCollapse()) {
      ...
      this.registry.set("levelCleared_3", true);
  ...
  protected didStructureCollapse() { //Collapses if the falling block goes below initial position of the two logs
    if (this.fallBlockOne.y > 545 && this.fallBlockTwo.y > 545) { 
      return true;
    }
    else if (this.fallBlockOne.y > 545 || this.fallBlockTwo.y > 545){
